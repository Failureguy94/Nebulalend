...
// //   const assets = [
// //     { symbol: 'ETH', name: 'Ethereum', price: 2340, change: 2.5, ltv: 0.8 },
// //     { symbol: 'BTC', name: 'Bitcoin', price: 43200, change: -1.2, ltv: 0.75 },
// //     { symbol: 'USDC', name: 'USD Coin', price: 1.0, change: 0.0, ltv: 0.9 },
// //     { symbol: 'LINK', name: 'Chainlink', price: 14.8, change: 5.2, ltv: 0.7 }
// //   ];
...
// //   const getHealthFactorColor = (factor: string) => {
...
// //               {walletConnected ? (
// //                 <div className="flex items-center gap-2 bg-green-900/20 border border-green-500/20 px-4 py-2 rounded-lg">
...
// //             <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
// //               <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
// //                 <h3 className="text-lg font-semibold mb-4 text-green-400">Lending Orders</h3>
...
// //               <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
// //                 <h3 className="text-lg font-semibold mb-4 text-red-400">Borrowing Orders</h3>
// //                 <div className="space-y-3">
...
// //                         <span className="text-gray-400">Best Rate</span>
// //                         <span className="text-green-400">4.1% APR</span>
// //                       </div>
// //                       <div className="flex justify-between text-sm mb-2">
// //                         <span className="text-gray-400">Health Factor</span>
// //                         <span className="text-yellow-400">1.6</span>
// //                       </div>
// //                       <div className="flex justify-between text-sm">
// //                         <span className="text-gray-400">Liquidation Price</span>
// //                         <span className="text-red-400">$1,980</span>
// //                       </div>
// //                     </div>
// //                   </div>
// //                 </div>
...
// //               <button className="w-full mt-6 bg-blue-600 hover:bg-blue-700 py-3 rounded-lg font-semibold transition-colors">
// //                 Borrow Assets
// //               </button>
// //             </div>
// //           </div>
...
// //           <div className="space-y-6">
// //             <h2 className="text-2xl font-bold">Liquidation Auctions</h2>
            
// //             <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
// //               <div className="text-center py-8">
// //                 <AlertTriangle className="mx-auto text-yellow-400 mb-4" size={48} />
// //                 <h3 className="text-lg font-semibold mb-2">No Active Liquidations</h3>
// //                 <p className="text-gray-400">All positions are currently healthy</p>
// //               </div>
// //             </div>
// //           </div>
// //         )}
